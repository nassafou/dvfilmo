...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/myapp')) {
            // FilmothequeBundle_homepage
            if (0 === strpos($pathinfo, '/myapp/hello') && preg_match('#^/myapp/hello/(?P<name>[^/]+?)$#s', $pathinfo, $matches)) {
                return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Myapp\\FilmothequeBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'FilmothequeBundle_homepage'));
            }
